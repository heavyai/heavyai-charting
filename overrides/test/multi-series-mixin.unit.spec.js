...
describe("MultiSeriesMixin", () => {
  ...
  describe('series method', () => {
    ...
    it('should return the series API', () => {
      expect(Object.keys(series)).to.deep.equal(['group', 'values','selected', 'keys'])
    })
    describe('series API', () => {
  ...
  describe('dataAsync callback', () => {
    ...
    describe('when chart is multi', () => {
      ...
      let results = [
        {val: 500, key1: 'other', key0: [{alias: "July 2008", value: new Date('7/1/2008') }, {alias: "July 2008", value: new Date('7/1/2008') }]},
        {val: 300, key1: 'D', key0: [{alias: "July 2008", value: new Date('7/1/2008') }, {alias: "July 2008", value: new Date('7/1/2008') }]},
        {val: 200, key1: 'R', key0: [{alias: "July 2008", value: new Date('7/1/2008') }, {alias: "July 2008", value: new Date('7/1/2008') }]},
        {val: 100, key1: 'L', key0: [{alias: "July 2008", value: new Date('7/1/2008') }, {alias: "July 2008", value: new Date('7/1/2008') }]},
        {val: 700, key1: 'I', key0: [{alias: "July 2008", value: new Date('7/1/2008') }, {alias: "July 2008", value: new Date('7/1/2008') }]},
        {val: 500, key1: 'other', key0: [{alias: "August 2008", value: new Date('8/1/2008') }, {alias: "August 2008", value: new Date('8/1/2008') }]},
        {val: 300, key1: 'D', key0: [{alias: "August 2008", value: new Date('8/1/2008') }, {alias: "August 2008", value: new Date('8/1/2008') }]},
        {val: 200, key1: 'R', key0: [{alias: "August 2008", value: new Date('8/1/2008') }, {alias: "August 2008", value: new Date('8/1/2008') }]},
        {val: 100, key1: 'L', key0: [{alias: "August 2008", value: new Date('8/1/2008') }, {alias: "August 2008", value: new Date('8/1/2008') }]},
        {val: 700, key1: 'I', key0: [{alias: "August 2008", value: new Date('8/1/2008') }, {alias: "August 2008", value: new Date('8/1/2008') }]},
      ]
      ...
      describe("processedResult when result is from extract", () => {
        ...
        before(function(done) {
          results = [
            {val: 500, key1: 'other', key0: [{alias: "July", value: 7, isExtract: true }]},
            {val: 300, key1: 'D', key0: [{alias: "July", value: 7, isExtract: true }]},
            {val: 200, key1: 'R', key0: [{alias: "July", value: 7, isExtract: true }]},
            {val: 100, key1: 'L', key0: [{alias: "July", value: 7, isExtract: true }]},
            {val: 700, key1: 'I', key0: [{alias: "July", value: 7, isExtract: true }]},
            {val: 500, key1: 'other', key0: [{alias: "August", value: 8, isExtract: true }]},
            {val: 300, key1: 'D', key0: [{alias: "August", value: 8, isExtract: true }]},
            {val: 200, key1: 'R', key0: [{alias: "August", value: 8, isExtract: true }]},
            {val: 100, key1: 'L', key0: [{alias: "August", value: 8, isExtract: true }]},
            {val: 700, key1: 'I', key0: [{alias: "August", value: 8, isExtract: true }]},
          ]
          chart.series().group(group)
          chart.group(group)
          chart.dimension(dimension)
        ...
        it('should call group all and process the results into a series format', () => {
          expect(processedResult).to.deep.equal([
            {
              key0: [
                {alias: "July", value: 7, isExtract: true },
              ],
              other: 500,
              series_2: 300,
              series_3: 200,
            ...
            {
              key0: [
                {alias: "August", value: 8, isExtract: true },
              ],
              other: 500,
              series_2: 300,
              series_3: 200,
