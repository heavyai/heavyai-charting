    ...
    data: [
      {
        ...
        format: "polys",
        sql:
          "SELECT rowid, mapd_geo, ZCTA5CE10 as color from zipcodes_2017 WHERE ZCTA5CE10 LIKE '55___'"
      }
    ],
    projections: [
      {
    ...
    data: [
      {
        ...
        format: "polys",
        sql:
          "SELECT rowid, ZCTA5CE10 as color, mapd_geo from zipcodes_2017 WHERE ZCTA5CE10 LIKE 'ab___'"
      }
    ],
    projections: [
      {
      ...
      data: [
        {
          ...
          format: "polys",
          sql:
            "SELECT nyc_buildings.bbl as key0, avg(heightroof) as color, SAMPLE(mapd_geo) as mapd_geo FROM nyc_buildings GROUP BY key0"
        }
      ],
      projections: [
        {
      ...
      data: [
        {
          ...
          format: "polys",
          sql:
            "SELECT nyc_buildings.bbl as key0, avg(cnstrct_yr) as color, SAMPLE(mapd_geo) as mapd_geo FROM nyc_buildings GROUP BY key0"
        }
      ],
      projections: [
        {
    ...
    data: [
      {
        ...
        format: "polys",
        sql:
          "SELECT tweets_2017_may.country as key0, avg(followees) as color, SAMPLE(mapd_countries.mapd_geo) as mapd_geo FROM tweets_2017_may, mapd_countries WHERE (tweets_2017_may.country = mapd_countries.name) GROUP BY key0"
      },
      {
    ...
    scales: [
      {
        name: "x",
        type: "linear",
        domain: [ -18608022.565838475, 19356755.56146388 ],
        range: "width"
      },
      {
        name: "y",
        type: "linear",
        domain: [ -19971868.878040362, 19971868.877909187 ],
        range: "height"
      },
      {
        name: "backendChoropleth_fillColor",
    ...
    data: [
      {
        ...
        format: "polys",
        sql:
          "SELECT ZCTA5CE10 as color, SAMPLE(mapd_geo) as mapd_geo FROM zipcodes_2017 GROUP BY color"
      }
    ],
    scales: [
      {
    ...
    data: [
      {
        ...
        format: "polys",
        sql:
          "SELECT rowid as key0, CASE WHEN rowid IN (25101) THEN LAST_SAMPLE(ZCTA5CE10) END as color, SAMPLE(mapd_geo) as mapd_geo FROM zipcodes_2017 GROUP BY key0"
      }
    ],
    scales: [
      {
    ...
    data: [
      {
        ...
        format: "polys",
        sql:
          "SELECT contributions.contributor_state as key0, sum(amount) as color, SAMPLE(us_states.mapd_geo) as mapd_geo FROM contributions, us_states WHERE (contributions.contributor_state = us_states.STUSPS) GROUP BY key0"
      },
      {
        name: "backendChoropleth_stats",
        source: "backendChoropleth",
    ...
    data: [
      {
        ...
        format: "polys",
        sql:
          "SELECT flights_123M.dest_state as key0, avg(arrdelay) as color, SAMPLE(us_states.mapd_geo) as mapd_geo FROM flights_123M, us_states WHERE (flights_123M.dest_state = us_states.STUSPS) GROUP BY key0"
      },
      {
        name: "backendChoropleth_stats",
        source: "backendChoropleth",
    ...
    scales: [
      {
        name: "x",
        type: "linear",
        domain: [ -19942765.32331395, 20012847.7332476 ],
        range: "width"
      },
      {
        name: "y",
        type: "linear",
        domain: [ -9620230.117018905, 19511287.095055554 ],
        range: "height"
      },
      {
        name: "backendChoropleth_fillColor",
    ...
    data: [
      {
        ...
        format: "polys",
        sql:
          "SELECT rowid, mapd_geo, NAME as color FROM mapd_states WHERE (ST_XMax(mapd_geo) >= -171.94850212956538 AND ST_XMin(mapd_geo) <= -64.23798693816666 AND ST_YMax(mapd_geo) >= 4.89805464614507 AND ST_YMin(mapd_geo) <= 74.02453067764594)"
      }
    ],
    projections: [
      {
    ...
    scales: [
      {
        name: "polys_fillColor",
        type: "ordinal",
        domain: [ "California", "Florida", "Texas", "Kentucky", "Minnesota", "Colorado" ],
