...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function createPointMap(polycfLayer1, pointcfLayer2, pointcfLayer3, con) {
    ...
    const polyDim1 = polycfLayer1.dimension("contributor_zipcode");
    ...
    const xDim2 = pointcfLayer2.dimension("goog_x");
    const yDim2 = pointcfLayer2.dimension("goog_y");
    ...
    // A filter is applied to these dimensions under the hood so that we only
    // render points that are within the view.
    const xDim3 = pointcfLayer3.dimension("merc_x");
    const yDim3 = pointcfLayer3.dimension("merc_y");
    ...
    pointcfLayer2.groupAll().reduce(extentMeasures).valuesAsync(true).then((extents) => {
      /*
      ...
      const pointMapChart = dc.rasterChart(parent, false) // create a raster chart. false indicates a scatterplot
