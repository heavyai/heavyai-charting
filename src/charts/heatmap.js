...
export default function heatMap(parent, chartGroup) {
  ...
  _chart.keyAccessorNoFormat = (forceMax = false) => datum =>
    keyAccessorNoFormat(datum, forceMax)
  const valueAccessorNoFormat = heatMapValueAccesorNoFormat.bind(_chart)
  _chart.valueAccessorNoFormat = (forceMax = false) => datum =>
    valueAccessorNoFormat(datum, forceMax)
