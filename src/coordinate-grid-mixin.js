import {constants, disableTransitions, globalTransitionDuration, optionalTransition, override, transition, units} from './core'
...
export default function coordinateGridMixin (_chart) {
     ...
     function zoomHandler () {
         ...
         var domFilter = filters.RangedFilter(domain[0], domain[1]);
 ...
 /* ------------------------------------------------------------------------ */
     ...
     _chart._brushing = function () {
         ...
         if (_chart.brushIsEmpty(extent)) {
             ...
             var rangedFilter = filters.RangedFilter(extent[0], extent[1]);
 ...
 /* ------------------------------------------------------------------------- */
     ...
     function generateClipPath () {
         var defs = utils.appendOrSelect(_parent, 'defs');
         // cannot select <clippath> elements; bug in WebKit, must select by id
         // https://groups.google.com/forum/#!topic/d3-js/6EpAzQ2gU9I
         var id = getClipPathId();
         var chartBodyClip = utils.appendOrSelect(defs, '#' + id, 'clipPath').attr('id', id);
 ...
 /* ------------------------------------------------------------------------- */
     ...
     _chart = overrideCoordinate(rangeMixin(binningMixin(_chart)))
