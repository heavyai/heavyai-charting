    ...
    it("should transform vega-lite spec (state) to full vega spec", () => {
      ...
      layer.setState(spec)
       ...
       expect(layer._genVega({
         ...
         data: {
           name: "heatmap_query",
           sql: "SELECT rect_pixel_bin_x(conv_4326_900913_x(lon), -50, -50, 1, 0, 100) as x, "
       ...
       layer.setState(Object.assign({}, spec, {mark: "hex"}))
        ...
        expect(layer._genVega({
          ...
          data: {
            name: "heatmap_query",
            sql: "SELECT reg_hex_horiz_pixel_bin_x(conv_4326_900913_x(lon),-50,-50,conv_4326_900913_y(lat),50,50,1,1.1547005383792517,0,0,100,100) as x, "
