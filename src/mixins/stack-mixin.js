...
import { pluck, utils, minVal, maxVal } from "../utils/utils"
import d3 from "d3"
...
export default function stackMixin(_chart) {
  ...
  _chart.xAxisMin = () =>
    utils.subtract(d3.min(flattenStack(), minVal), _chart.xAxisPadding())

  _chart.xAxisMax = () =>
    utils.add(d3.max(flattenStack(), maxVal), _chart.xAxisPadding())
