    ...
    data: [
      {
        name: "pointmap",
        sql:
          "SELECT conv_4326_900913_x(dest_lon) as x, conv_4326_900913_y(dest_lat) as y, carrier_name as color, flights.rowid FROM flights WHERE (dest_lon >= -158.707193074989 AND dest_lon <= -38.57095522584763) AND (dest_lat >= 25.2818736395824 AND dest_lat <= 59.57201252897744)"
      }
    ],
    scales: [
      {
