...
module.exports = function(test_collection, expect) {
  ...
  const empty_test = new RenderVegaTest(vega, (result) =>
  ...
  symbol_test_grp.addTest(
    ...
    new RenderVegaTest(vega, (result) =>
      expect(result).to.matchGoldenImage("symbol_update_data_test_01.png")
    )
  );
